...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="animate-in">
      <Link
        href="/login"
        className="mb-6 inline-flex items-center gap-1.5 text-sm font-semibold text-text-muted hover:text-primary"
      >
      ...
      {step === "otp" && (
        <>
          ...
          <p className="mt-2 text-sm text-text-muted">
            ...
            <br />
            <span className="text-xs">(Demo code: <span className="font-semibold">123456</span>)</span>
          </p>
      ...
      {step === "reset" && (
        <>
          ...
          <p className="mt-2 text-sm text-text-muted">Choose a strong password for your account.</p>
          <form
            onSubmit={advance("done", () => {
